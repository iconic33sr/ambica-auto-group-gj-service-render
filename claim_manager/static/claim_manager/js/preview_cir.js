document.addEventListener("DOMContentLoaded", function () {
    ...
    page_body.addEventListener('keydown', (event) => {
        if (event.key === 'Escape') {
            ...
            if (document.getElementById("rejection_reason_cont").style.display == "none"){
            ...
            document.getElementById("save_btn").value = "REJECT";
        }
    });
    ...
    ///////////////////////// To toggle between Reject and Submit  /////////////////////////
    ...
    if (document.getElementById("rejection_reason_cont").style.display == "block") {
