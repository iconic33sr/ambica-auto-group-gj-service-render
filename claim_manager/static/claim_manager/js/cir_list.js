...
socket.addEventListener("message", function(event) {
    ...
    // ADD card (claim manager or similar)
    if (message.action === "add") {
        ...
        card.innerHTML = `
            ...
            <div class="report_heading_cont">
                <div class="report_sub_heading"><div>${data.wm_name}<span class="name_label"> (Work Manager) </span></div></div>
                <div class="report_sub_heading"><div>${formatToDisplayDate(data.wm_date_time)}</div></div>
            </div>
    ...
    if (message.action === "remove") {
        ...
        // Show "No Pending CIR" message if no cards left
